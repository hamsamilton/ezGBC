...
# plot size
    ...
    seaborn.lineplot(x = "Percentile", y = "Normalized Counts", data=dfm, hue = "Samples", palette = "Set1")
...
#  make the heatmap for genebody coverage ---------------------------------------------
    ...
    ax.tick_params(axis='y', length=8, color='black', labelsize=18, pad=10, rotation=45)
